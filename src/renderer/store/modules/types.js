...
// SUBJECTS DATA
export const LOAD_SUBECTS_SUCCESS = "LOAD_SUBECTS_SUCCESS";
export const LOAD_SUBECTS_ERROR = "LOAD_SUBECTS_ERROR";
export const ADD_SUBECT_SUCCESS = "ADD_SUBECT_SUCCESS";
export const UPDATE_SUBECT_SUCCESS = "UPDATE_SUBECT_SUCCESS";
